...
-- [x]The bank is giving a new customer bonus! Update all records with an 
...
-- [x]Get the username and account balance of the 3 users with the highest 
...
-- [x]Get the username and account balance of the 3 users with the lowest
...
transactions_attempted, account_balance) VALUES('laura', 'twinPeaks', 
9, 10, 237.00);
